...
// $Id: DifferenceExpression.java,v 1.5 2005/02/21 17:29:18 huesselbeck Exp $
 ...
 */
public class DifferenceExpression extends Arg2Expression {
	 ...
	 */
	public DifferenceExpression(Expression arg1, Expression arg2) {
		super("-",arg1,arg2);
	}
