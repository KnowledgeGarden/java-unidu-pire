...
public class Config {
     ...
     *
     * @param init map with initial keys
     */
     ...
     *
     * @param writer writer for the config
     */
...
//     *
//     * @param key key to be retrieved
//     * @param map map which is used if the key is not found in the config
//     * @return value or null if the key is not stored
//     */
...
//    }
     ...
     *
     * @param m map which will be added to the config
     */
