...
public class Literal {
    ...
    public Literal(String predicateName, List arguments, boolean positive) {
        this.predicateName = predicateName;
        this.arguments =
                (Expression[]) arguments.toArray(new Expression[0]);
        this.positive = positive;
    }
    ...
    public Literal(Literal literal) {
        ...
        System.arraycopy(literal.arguments, 0, this.arguments, 0, literal.arguments.length);
    ...
    public String getArguments() {
        ...
        for (int i = 0; i < arguments.length; i++)
            ret.append(arguments[i]).append(i < arguments.length - 1 ? "," : "");
        return ret.toString();
    }
