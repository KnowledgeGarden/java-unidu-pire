...
public class SubSet {
     ...
     * empty.
     *
     * @param card the cardinality of the superset
     * @see #SubSet(int, int)
     ...
     *
     * @param card  the cardinality of the superset
     * @param value the value describing this SubSet
     * @see #SubSet(int)
     * @see #SubSet(int, String)
     */
     ...
     *
     * @param value the value of the specified SubSet
     * @param card  the cardinality of the superset of the specified SubSet
     ...
     * </ul>
     *
     * @param value1 the integer corresponding to the first SubSet to be tested
     * @param value2 the integer corresponding to the second SubSet to be tested
     ...
     *
     * @param value the integer value describing the new content of this SubSet
     */
     ...
     *
     * @param value the reverse binary string describing the new content of this
     *              SubSet
     */
     ...
     *
     * @param num the number to be testes
     ...
     * operation.
     *
     * @param subSet the subSet containing all numbers to be removed from this
     *               SubSet
     */
     ...
     * </ul>
     *
     * @param o the Object to be compared for equality with this SubSet
    ...
    public String toString() {
        StringBuilder str = new StringBuilder();
        for (boolean flag : flags) str.insert(0, (flag ? "1" : "0"));
        return str.toString();
    }
