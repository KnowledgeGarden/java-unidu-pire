...
// $Id: GreaterEqualsRelation.java,v 1.7 2005/03/14 17:33:13 nottelma Exp $
...
/**
 * A class for the pDatalog++ greater-equals relation which is computed on demand.
 * 
 * @author Henrik Nottelmann
 * @since 2003-10-07
 * @version $Revision: 1.7 $, $Date: 2005/03/14 17:33:13 $
 */
public class GreaterEqualsRelation extends EDBComputedRelation {
	 ...
	 */
	public GreaterEqualsRelation(RelationBase base) {
		super(base, "ge", 2);
	}
