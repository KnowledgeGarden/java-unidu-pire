...
public SimpleLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("PROB", this), new Integer(8));
}
...
tryAgain:
	...
	public final void mENDRULE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ENDRULE;
		int _saveIndex;
	...
	public final void mLCURL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LCURL;
		int _saveIndex;
	...
	public final void mRCURL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = RCURL;
		int _saveIndex;
