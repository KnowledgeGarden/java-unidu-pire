...
// $Id: GreaterThanRelation.java,v 1.6 2005/03/14 17:33:13 nottelma Exp $
...
/**
 * A class for the pDatalog++ greater-than relation which is computed on demand.
 *
 * @author Henrik Nottelmann
 * @version $Revision: 1.6 $, $Date: 2005/03/14 17:33:13 $
 * @since 2003-10-07
 */
public class GreaterThanRelation extends EDBComputedRelation {
     ...
     */
    public GreaterThanRelation(RelationBase base) {
        super(base, "gt", 2);
    }
