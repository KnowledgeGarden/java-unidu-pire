...
public class Harvester {
	...
	private boolean isInRequestedRange(String identifier) {
		...
		if ((toId != null) && (toId.compareTo(identifier) < 0)) {
			return false;
		}
		return true;
	}

	private void makeDir(String path) throws OAIException {
		try {
	 ...
	 * @return
	 */
	private String makeFilename(String identifier) {
	...
	public static void main(String[] args) {
		...
		args = (String[]) testing.toArray(new String[testing.size()]);
