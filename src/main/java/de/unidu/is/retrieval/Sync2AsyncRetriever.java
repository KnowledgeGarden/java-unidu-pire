...
public class Sync2AsyncRetriever implements AsyncRetriever {
     ...
     *
     * @param retriever retriever object to be used
     */
    ...
    public void getSchemaCall(final AsyncCallResponseListener listener) {
        new Thread(() -> listener.resultEvent(new AsyncCallResponseEvent(
                Sync2AsyncRetriever.this, retriever.getSchema()))).start();
    }
        ...
        new Thread(() -> {
            try {
                listener.resultEvent(new AsyncCallResponseEvent(
                        Sync2AsyncRetriever.this, retriever
                        .getResult(query)));
            } catch (UnsupportedQueryException | IndexException e) {
                listener.faultEvent(new AsyncCallResponseEvent(
                        Sync2AsyncRetriever.this, e));
            }
        }).start();
    ...
    public void getResultSummariesCall(
        ...
        new Thread(() -> {
            ...
            } catch (UnsupportedQueryException | DocumentNotFoundException | IndexException e) {
                listener.faultEvent(new AsyncCallResponseEvent(
                        Sync2AsyncRetriever.this, e));
            }
        }).start();
