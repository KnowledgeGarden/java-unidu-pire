...
public class SchemaElement {
     ...
     *
     * @param name         name of the schema element
     * @param datatypeName datatype of the schema element
     ...
     *
     * @param name name of this schema element
     */
     ...
     *
     * @param operators list of schema element operators (as strings)
     */
    ...
    public List getXPaths() {
        ...
        for (Iterator it = children(); it.hasNext(); ) {
            ...
            for (Object o : element.getXPaths()) {
     ...
     *
     * @param buf   string buffer for the hierarchical view
    ...
    public void appendHierarchicalView(StringBuffer buf, int depth) {
        ...
        for (Object child : children) {
            SchemaElement element = (SchemaElement) child;
