...
public class PDatalogIR extends AbstractRetriever implements MomentsIR {
     ...
     * @param db             database
     * @param collectionName name of the collection
     * @param docDir         directory for added documents
     */
    ...
    public void registerSchema(Schema schema) {
        ...
        for (Object o : schema.getAliases()) {
            ...
            for (Object originalOperator : originalOperators) {
                String operator = (String) originalOperator;
     ...
     */
    private static String convertDatatypeName(String datatypeName) {
     ...
     */
    private static String convertOperatorName(String operator) {
    ...
    public void addToIndex(String docID, Document document)
        ...
        // save document
        if (docDir != null) {
            try (PrintWriter pw = new PrintWriter(new FileWriter(new File(docDir, docID
                    + ".xml")))) {
    ...
    public List getResult(Query query) throws UnsupportedQueryException {
        ...
        if (query instanceof StructuredQuery) {
            ...
            for (Object o : wsum.getConditionsTuples()) {
                WeightedQueryCondition cond = (WeightedQueryCondition) o;
