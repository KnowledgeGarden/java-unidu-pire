...
public class PDatalogIndex implements Index {
     ...
     */
    protected final Map removeRelations;

    /**
     * Creates a new index.
     *
     * @param base           relation base
     ...
     *
     * @param create if true, the relations are physically created
     */
    ...
    public void addRule(String queryID, String[] relations, double prob,
        ...
        for (String relation : relations) {
            body.add(new Literal(relation, new Expression[]{new Variable(
                    "D")}, true));
            rr.add(relation);
        }
     ...
     *
     * @param queryID         query id
     * @param list            list of rules for computing the probabilities of relevance
     ...
     * @param arity        target relation arity
     * @param rules        collection of rules for target relation
     */
