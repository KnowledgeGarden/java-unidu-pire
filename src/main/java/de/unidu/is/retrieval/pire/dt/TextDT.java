...
// $Id: TextDT.java,v 1.21 2005/03/14 17:33:13 nottelma Exp $
 ...
 * @since 2003-08-16
 * @version $Revision: 1.21 $, $Date: 2005/03/14 17:33:13 $
 */
public class TextDT extends AbstractDT {
	...
	static {
		...
		Filter rawContainsQueryFilter = new StemmerFilter(new StopwordFilter(
				new LowercaseFilter(wordSplitterFilter)));
	 ...
	 *               weights
	 */
	private boolean isTFOperator(String operator) {
	 ...
	 *               indexing weights
	 */
	private boolean isTFIDFOperator(String operator) {
	...
	public void computeIndex(Index index, String operator) {
		...
		if (isTFOperator(operator)) {
			...
			String nd = numDocsInRD == 0 ? "NUMDOCS" : "" + numDocsInRD;
	 ...
	 * 
	 * @param flag
	 *                   flag for enabling or disabling the RSV scaling
	 */
	public static void setDoMapForBM25(boolean flag) {
		TextDT.doMapForBM25 = flag;
	}
	 ...
	 * 
	 * @param flag
	 *                   flag for enabling or disabling the logistic mapping function
	 */
	public static void setDoScaleForBM25(boolean flag) {
		TextDT.doScaleForBM25 = flag;
	}
