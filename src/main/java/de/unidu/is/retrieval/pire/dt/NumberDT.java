...
public class NumberDT extends AbstractDT {
	 ...
	 *                       component
	 */
	protected boolean includesLess(String operator) {
		return operator.indexOf("<") != -1 || operator.indexOf("l") != -1;
	}
	 ...
	 *         than" component
	 */
	protected boolean includesGreater(String operator) {
		return operator.indexOf(">") != -1 || operator.indexOf("g") != -1;
	}
	 ...
	 */
	protected boolean includesEqual(String operator) {
		return operator.indexOf("=") != -1 || operator.indexOf("e") != -1;
	}
	 ...
	 */
	protected boolean isVague(String operator) {
		return operator.indexOf("~") != -1 || operator.indexOf("v") != -1;
	}
