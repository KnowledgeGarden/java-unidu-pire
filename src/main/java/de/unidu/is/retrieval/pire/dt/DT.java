...
public interface DT {
     ...
     *
     * @param operator search operator name
     ...
     */
    void addToIndex(Index index, String docID, String operator,
                    Object value);
     ...
     * @param operator search operator name
     */
    void computeIndex(Index index, String operator);
     ...
     */
    Iterator getIndexTokens(Index index, String operator);
     ...
     * @param operator search operator name
     */
    void removeIndex(Index index, String operator);
     ...
     */
    boolean storedRSVs(String operator);
     ...
     * @param addList    list to where the condition rules have to be added
     */
    void addRSVRules(Index index, String queryID,
     ...
     * @param subqueryID subquery id
     * @param operator   search operator name
     * @param addList    list to which rules can be appended
     */
    void addProbRules(Index index, String queryID,
