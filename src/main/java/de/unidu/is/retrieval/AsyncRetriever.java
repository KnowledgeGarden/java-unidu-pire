...
public interface AsyncRetriever {
     ...
     * @param query    XIRQL query
     */
    void getResultSummariesCall(AsyncCallResponseListener listener,
                                Query query);
     ...
     */
    void getSummaryCall(AsyncCallResponseListener listener, String docID);

    /**
     * Asynchronous variant of getSummary
     *
     * @param listener response listener
     * @param probDoc  document
     */
    void getSummaryCall(AsyncCallResponseListener listener,
                        ProbDoc probDoc);
     ...
     *
     * @param listener response listener
     * @param docs     list of ProbDoc instances
     */
    void getSummariesCall(AsyncCallResponseListener listener, List docs);
     ...
     * @param docID    document id
     */
    void getDocumentCall(AsyncCallResponseListener listener, String docID);

    /**
     * Asynchronous variant of getDocument.
     *
     * @param probDoc document descriptor
     */
    void getDocumentCall(AsyncCallResponseListener listener,
                         ProbDoc probDoc);
     ...
     *
     * @param listener response listener
     * @param docList  list of ProbDoc instances
     */
    void getDocumentsCall(AsyncCallResponseListener listener,
                          List docList);
