...
public class NormalDistribution extends Distribution {
     ...
     * and variance.
     *
     * @param moments moments of the normal distribution
     */
     ...
     * and variance.
     *
     * @param expectation expectation of the normal distribution
    ...
    public double inverse(double y) {
        try { // is cern package is available, use it
            ...
            for (Method method : array)
                if (method.getName().equals("normalInverse")) {
                    m = method;
                    break;
                }
            return moments.getExpectation()
                    + moments.getStandardDeviation()
                    * (Double) m.invoke(null, new Object[]{y});
        } catch (Exception e) {
