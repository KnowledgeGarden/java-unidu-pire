...
public class DelegatedPropertyMapTest extends TestCase {
    ...
    public void testSetGet() {
        ...
        assertTrue(map1.getBoolean("a5"));
        assertFalse(map1.getBoolean("a6"));
        try {
            assertEquals(map1.getInt("a1"), 2);
            fail("a1 - int");
        } catch (Exception e) {
        }
        assertFalse(map1.getBoolean("a1"));
    ...
    public void testDelegation() {
        ...
        assertFalse(map1.containsKey("c"));
        map12.put("a", "11");
    ...
    public void testConversion() {
        ...
        assertTrue(map1.getBoolean("my.a"));
        map1.setBoolean("my.b", false);
        assertFalse(map1.getBoolean("my.a"));
