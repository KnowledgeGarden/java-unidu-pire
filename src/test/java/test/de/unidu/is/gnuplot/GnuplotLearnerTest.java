    ...
    public void testLearndoubleArraydoubleArrayStringStringArray1() {
        Map results =
                learner.learn(
                        ...
                        "f(y)=l*y+a",
                        new String[]{"l", "a"});
        assertEquals((Double) results.get("l"), 1, 0.0001);
        assertEquals((Double) results.get("a"), 2, 0.0001);
    }
    ...
    public void testLearndoubleArraydoubleArrayStringStringArray2() {
        Map results =
                learner.learn(
                        ...
                        "f(y)=l*y+a",
                        new String[]{"l", "a"});
        assertEquals((Double) results.get("l"), 3, 0.0001);
        assertEquals((Double) results.get("a"), 0, 0.0001);
    }
